...
```{r}
veri_results_all = doppelgangerVerification(
...
displayVerificationResults(functionalityResults = veri_results_all,
...
```{r fig.width=10, fig.height=5}
veri_results_all_extra = doppelgangerVerification(
  experimentPlanFilename = "cleaned_data/all_experiment_plan.csv",
  raw_data = all,
  meta_data = all_meta)
originalTrainValidNames =  c("Doppel_0", "Doppel_1_Unbal", "Doppel_1", "Doppel_2","Doppel_3","Doppel_4", "Doppel_5", "Neg_Con", "Pos_Con_5")
...
displayVerificationResults(functionalityResults = veri_results_all_extra,
                originalTrainValidNames = originalTrainValidNames,
                newTrainValidNames = newTrainValidNames)
```
## Arrange plots
...
all_plot2 = displayVerificationResults(functionalityResults = veri_results_all,
                originalTrainValidNames = originalTrainValidNames,
                newTrainValidNames = newTrainValidNames)
