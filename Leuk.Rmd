...
```{r}
veri_results_leuk = doppelgangerVerification(
      experimentPlanFilename = "cleaned_data/leuk_experiment_plan.csv",
      raw_data = doppel_ag_over$Batch_corrected,
      meta_data = leuk_meta,
      do.batch.corr = FALSE,
      k=7)
```
...
displayVerificationResults(functionalityResults = veri_results_leuk,
...
```{r fig.width=10, fig.height=5}
veri_results_leuk_extra = doppelgangerVerification(
      experimentPlanFilename = "cleaned_data/leuk_experiment_plan.csv",
      raw_data = leuk,
      meta_data = leuk_meta)
...
displayVerificationResults(functionalityResults = veri_results_leuk_extra,
                originalTrainValidNames = originalTrainValidNames,
                newTrainValidNames = newTrainValidNames)

```

The importance of k in verification
...
leuk_plot2 = displayVerificationResults(functionalityResults = veri_results_leuk,
                originalTrainValidNames = originalTrainValidNames,
                newTrainValidNames = newTrainValidNames)
