...
```{r}
veri_results_dmd_no_combat =  doppelgangerVerification(
  experimentPlanFilename = "cleaned_data/dmd_no_combat_experiment_plan.csv",
  raw_data = dmd,
  meta_data = dmd_meta,
  do.batch.corr = TRUE,
  k=5)
...
displayVerificationResults(functionalityResults = veri_results_dmd_no_combat,
